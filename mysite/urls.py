...
urlpatterns = [
    ...
    path('home/clas/admin/results', views.SeasSearchView.as_view()),
    ...
    path('home/clas/admin/ASequivalencies', views.ClasTransferView.as_view()),
    ...
    path('home/clas/admin/transfer_AS', views.transfer_AS),
    path('home/seas/approved', views.ApprovedTransferView.as_view()),
    path('home/clas/approved', views.ApprovedTransferView_AS.as_view()),
    ...
    path('home/pendingAS', views.pend_AS),
    path('home/seas/freeSearch', views.freeSearch),
    path('home/clas/freeSearchAS', views.freeSearchAS),
    path('home/seas/admin/freeSearch', views.freeSearch),
    path('home/clas/admin/freeSearchAS', views.freeSearchAS)
]
